...
import 'package:monitorpresensi/app/utils/pengecualianDTS.dart';
                              ...
                              Get.dialog(
                                dialogAddPengecualian(
                                    ...
                                    btnDefaultIcon1(
                                        ...
                                        "Kirim",
                                        getTextBtnAction(context), () {
                                      if (textC.addPengecualianKey.value
                                              .currentState!
                                              .validate() &&
                                          cDropdown
                                              .addPengecualianStatusLiburKey
                                              .value
                                              .currentState!
                                              .validate() &&
                                          textC
                                              .datepickerKey.value.currentState!
                                              .validate()) {
                                        c.addPengecualian(
                                          textC.addPengecualianC.text,
                                          cDropdown
                                              .addPengecualianStatusLiburC.text,
                                        );
                                      }
                                    })),
                              );
