// ignore_for_file: unnecessary_overrides, unused_local_variable, invalid_use_of_protected_member
...
class RiwayatPresensiMobileController extends GetxController {
  ...
  Rx<DateTime> currentMonth1 = DateTime.now().obs;

  void setCurrentMonth1(DateTime month) {
    currentMonth1.value = month;
  }
  ...
  Future<void> getPercentagePresence(
